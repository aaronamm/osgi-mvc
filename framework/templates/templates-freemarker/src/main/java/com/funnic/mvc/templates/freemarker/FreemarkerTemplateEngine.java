...
public class FreemarkerTemplateEngine implements TemplateEngine, TemplateLoader {
	...
	private final ViewRepositoryManager viewRepositoryManager;
	private final HtmlDirective htmlDirective;
	private final Configuration cfg;
	private static ThreadLocal<Stack<Bundle>> currentBundle = new ThreadLocal<Stack<Bundle>>();

	public FreemarkerTemplateEngine(final ViewRepositoryManager viewRepositoryManager, final HtmlDirective htmlDirective) {
		this.viewRepositoryManager = viewRepositoryManager;
	...
	public Object findTemplateSource(final String path) {
		...
		try {
			final ViewInfo info = viewRepositoryManager.getView(currentBundle, path);
